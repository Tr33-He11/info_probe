...
<body>
	...
	$json2 = file_get_contents("http://api.map.baidu.com/geocoder/v2/?callback=renderReverse&location=".$lat.",".$lon."&output=json&pois=1&ak=Auw8fjSnrElKxlcSz9PItXxRBytWYMN5");
